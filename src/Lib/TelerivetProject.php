 ...
 */
class TelerivetProject extends TelerivetEntity
{
    /**
    ...
    {
        return new TelerivetMessage($this->_api, $this->_api->doRequest('POST', $this->getBaseApiPath() . '/messages/send', $options));
    }
     ...
     */
    public function sendMessages($options)
    {
     ...
     */
    public function scheduleMessage($options)
    {
        return new TelerivetScheduledMessage($this->_api, $this->_api->doRequest('POST', $this->getBaseApiPath() . '/scheduled', $options));
    }
     ...
     */
    public function getOrCreateContact($options)
    {
        $data = $this->_api->doRequest("POST", "{$this->getBaseApiPath()}/contacts", $options);
        return new TelerivetContact($this->_api, $data);
    }
    ...
    {
        return new TelerivetContact($this->_api, $this->_api->doRequest("GET", "{$this->getBaseApiPath()}/contacts/{$id}"));
    }
    ...
    Telerivet_Contact
     */
    public function initContactById($id)
    {
        return new TelerivetContact($this->_api, array('project_id' => $this->id, 'id' => $id), false);
    }
     ...
     */
    public function queryPhones($options = null)
    {
    ...
    {
        return new TelerivetPhone($this->_api, $this->_api->doRequest("GET", "{$this->getBaseApiPath()}/phones/{$id}"));
    }
    ...
    Telerivet_Phone
     */
    public function initPhoneById($id)
    {
        return new TelerivetPhone($this->_api, array('project_id' => $this->id, 'id' => $id), false);
    }
     ...
     */
    public function queryMessages($options = null)
    {
    ...
    {
        return new TelerivetMessage($this->_api, $this->_api->doRequest("GET", "{$this->getBaseApiPath()}/messages/{$id}"));
    }
    ...
    Telerivet_Message
     */
    public function initMessageById($id)
    {
        return new TelerivetMessage($this->_api, array('project_id' => $this->id, 'id' => $id), false);
    }
     ...
     */
    public function queryGroups($options = null)
    {
    ...
    Telerivet_Group
     */
    public function getOrCreateGroup($name)
    {
        return new TelerivetGroup($this->_api, $this->_api->doRequest("POST", "{$this->getBaseApiPath()}/groups", array('name' => $name)));
    }
    ...
    {
        return new TelerivetGroup($this->_api, $this->_api->doRequest("GET", "{$this->getBaseApiPath()}/groups/{$id}"));
    }
    ...
    Telerivet_Group
     */
    public function initGroupById($id)
    {
        return new TelerivetGroup($this->_api, array('project_id' => $this->id, 'id' => $id), false);
    }
     ...
     */
    public function queryLabels($options = null)
    {
    ...
    {
        return new TelerivetLabel($this->_api, $this->_api->doRequest("POST", "{$this->getBaseApiPath()}/labels", array('name' => $name)));
    }
    ...
    {
        return new TelerivetLabel($this->_api, $this->_api->doRequest("GET", "{$this->getBaseApiPath()}/labels/{$id}"));
    }
    ...
    Telerivet_Label
     */
    public function initLabelById($id)
    {
        return new TelerivetLabel($this->_api, array('project_id' => $this->id, 'id' => $id), false);
    }
     ...
     */
    public function queryDataTables($options = null)
    {
    ...
    Telerivet_DataTable
     */
    public function getOrCreateDataTable($name)
    {
        return new TelerivetDataTable($this->_api, $this->_api->doRequest("POST", "{$this->getBaseApiPath()}/tables", array('name' => $name)));
    }
    ...
    {
        return new TelerivetDataTable($this->_api, $this->_api->doRequest("GET", "{$this->getBaseApiPath()}/tables/{$id}"));
    }
    ...
    Telerivet_DataTable
     */
    public function initDataTableById($id)
    {
        return new TelerivetDataTable($this->_api, array('project_id' => $this->id, 'id' => $id), false);
    }
    ...
    Telerivet_ScheduledMessage
     */
    public function getScheduledMessageById($id)
    {
        return new TelerivetScheduledMessage($this->_api, $this->_api->doRequest("GET", "{$this->getBaseApiPath()}/scheduled/{$id}"));
    }
    ...
    Telerivet_ScheduledMessage
     */
    public function initScheduledMessageById($id)
    {
        return new TelerivetScheduledMessage($this->_api, array('project_id' => $this->id, 'id' => $id), false);
    }
     ...
     */
    public function queryServices($options = null)
    {
    ...
    {
        return new TelerivetService($this->_api, $this->_api->doRequest("GET", "{$this->getBaseApiPath()}/services/{$id}"));
    }
    ...
    Telerivet_Service
     */
    public function initServiceById($id)
    {
        return new TelerivetService($this->_api, array('project_id' => $this->id, 'id' => $id), false);
    }
     ...
     */
    public function queryReceipts($options = null)
    {
    ...
    {
        return new TelerivetMobileMoneyReceipt($this->_api, $this->_api->doRequest("GET", "{$this->getBaseApiPath()}/receipts/{$id}"));
    }
    ...
    Telerivet_MobileMoneyReceipt
     */
    public function initReceiptById($id)
    {
        return new TelerivetMobileMoneyReceipt($this->_api, array('project_id' => $this->id, 'id' => $id), false);
    }
     ...
     */
    public function queryRoutes($options = null)
    {
    ...
    {
        return new TelerivetRoute($this->_api, $this->_api->doRequest("GET", "{$this->getBaseApiPath()}/routes/{$id}"));
    }
    ...
    Telerivet_Route
     */
    public function initRouteById($id)
    {
        return new TelerivetRoute($this->_api, array('project_id' => $this->id, 'id' => $id), false);
    }
