...
class TelerivetApiCursor
{
    ...
    public function __construct($api, $item_cls, $path, $params)
    {
        if (!isset($params)) {
            $params = array();
        }
        if (isset($params['count'])) {
            throw new TelerivetException("Cannot construct Telerivet_ApiCursor with 'count' parameter. Call the count() method instead.");
        }
